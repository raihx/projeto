                            ...
                            if(mysqli_num_rows($query_run) > 0) {
                                ...
                                <form action="functions_data.php" method="POST">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="descricao_artigo" value="<?=$artigo_data['descricao'];?>" class="form-control">
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        <label>Imagem</label>
                                        <br>
                                        <img src="../images/produtos/<?=$artigo_data['imagem']?>" width="200px" height="200px">
                                    </div>
